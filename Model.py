...
from keras.layers import Deconv2D, Conv2D, MaxPooling2D, Dropout, UpSampling2D, Convolution2D
...
class Model:
    def __init__(self):
        ...
        self.epochs = 20
        self.pool_size = (2, 2)
        self.input_shape = (1500, 1500)
        self.output_shape = (1500, 1500)

        self.model = Sequential()
        self.model.add(Conv2D(60, (3, 3), input_shape=self.input_shape, border_mode='valid', subsample=(1, 1), activation='relu'))
